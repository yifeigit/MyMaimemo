...
| 模块 | 说明 |
|------|------|
| **今日看板** | 一屏聚合：今日进度（完成/总数 + 进度条 + 百分比）、计划总词数、继续学习、7 日到期复习量 |
...
打开面板即见全貌——进度条、KPI 卡片、收藏词一目了然。

<img src="screenshots/dashboard.png" alt="今日看板" width="420"/>

### ② 智能查词 + AI 释义

输入单词自动判定是否已背；未背则自动加入「我的收藏」。点击「AI 释义」获取深度讲解。

<img src="screenshots/lookup-ai.png" alt="智能查词与AI释义" width="420"/>

### ③ 单词小文章

基于当日已背词汇生成连贯故事，逐句中英对照，目标词高亮标注。

<img src="screenshots/story.png" alt="单词小文章" width="420"/>
...
| 数据项 | 来源 | 条件 |
|--------|------|------|
| 今日进度 / 继续学习 / 计划总词数 / 7日到期 | 墨墨学习接口 | App 需开启「自动同步」 |
