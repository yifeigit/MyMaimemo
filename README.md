...
<p align="center">
  <strong>查词 · 看板 · AI 释义 · 单词创造 —— 四合一学习面板</strong>
</p>
...
| **单词创造** | 基于「今日已背」词汇生成**相互独立的英文例句**（无需连贯故事，每句一个场景），目标词汇绿色高亮，支持一键复制全文 |
...
填好 Token 即可查词和看板。如需 **AI 释义** 和 **单词创造**，还需配置 LLM：
...
| AI 释义 / 单词创造 | LLM API | 需配置 LLM Key |
